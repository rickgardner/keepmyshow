...
****************************************************/
	$db_server			= DB_HOST;				// Database server, usually "localhost", 
 	...
 	$db_name 			= 'keepmyshow';				// Database name, leave empty for 'all databases'
...
/***************************************************
	E-mail settings
****************************************************/
 	$website            = 'keepmyshow.com';		    // Your site's domain (without www. part)
	$send_to 	    = 'rickgardner@gmail.com';		        // backup file will be sent to?
	$from 		    = 'rickgardner@gmail.com';	// some hosting providers won’t let you send backups from invalid e-mail address
...
****************************************************/
    ...
    $full_path      = '/srv/www/keepmyshow/current/bkup';
